...
open class ModelForge {
    ...
    open fun <T> build(clazz: Class<T>): T {
        ...
        clazz.eligibleFields().map { field ->
            ...
            field.set(model, field.type.generate(field))
        }
     ...
     */
    private fun <T> Class<T>.generate(field: Field): Any = when (this) {
        ...
        List::class.java -> field.getValues()
    ...
    private fun Field.getValues(size: Int = 10): Any {
        ...
        for (i in 0 until size) {
            list.add(i, clazz.generate(this))
        }
        return list
    }
}
