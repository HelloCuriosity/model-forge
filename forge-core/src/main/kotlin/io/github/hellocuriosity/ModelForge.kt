...
open class ModelForge {
        ...
        return clazz.generate {
            ...
            attempt {
                ...
                clazz.eligibleFields().map { field ->
                    ...
                    when (field.type) {
                        List::class.java -> field.set(model, field.getListValues())
                        Set::class.java -> field.set(model, field.getSetValues())
     ...
     */
    private fun Field.getListValues(size: Int = 10): Any {
    ...
    /**
     * Auto generate set values
     *
     * @param Field Field needed to determine set type
     * @param size Int number of items to create (defaulting to 10)
     *
     * @return Autogenerated set values
     */
    private fun Field.getSetValues(size: Int = 10): Any {
        val type = genericType as ParameterizedType
        val clazz = type.actualTypeArguments.first() as Class<*>
        return buildSet(clazz, size)
    }
}
